...
from .config_rm_isf_umi_left import RmIsfUmiLeftConfig
...
class RmIsfUmiLeft(Robot):
    """睿尔曼 RM75b 单左臂 ugripper。"""

    config_class = RmIsfUmiLeftConfig
    name = "rm_isf_umi_left"
    kinematics_force_type = RmIsfUmiLeftConfig.kinematics_force_type
    ...
    def __init__(self, config: RmIsfUmiLeftConfig):
    ...
    def _ensure_algo(self):
        ...
        if self._algo is None:
            ...
            self._algo = make_realman_algo(self.kinematics_force_type)
        return self._algo
