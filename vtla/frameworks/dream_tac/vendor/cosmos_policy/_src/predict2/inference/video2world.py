...
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. python cosmos_policy/_src/predict2/inference/video2world.py \
...
class Video2WorldInference:
    ...
    def __init__(
        ...
        config_file: str = "cosmos_policy/_src/predict2/configs/video2world/config.py",
        ...
        if TYPE_CHECKING:
            from cosmos_policy._src.predict2.models.video2world_model_rectified_flow import (
    ...
    def _get_data_batch_input(
        ...
        data_batch = {
            ...
            # CFGRL-style optimality label for guided sampling.
            # Convention:
            # -1 => ∅ (unconditional), 0..K-1 => conditioned bins (binary K=2 by default).
            # If you don't use CFGRL-style guidance, you can leave this at -1.
            "optimality": torch.full((self.batch_size,), -1, dtype=torch.long),
        }
