...
# Modified by StarVTLA: construct the optional Reason1/Qwen stack lazily so
# cached Dream-Tac T5 contexts work with the repository's Transformers runtime.
...
def _default_reason1_model_config():
    """Build Reason1 lazily; cached Dream-Tac T5 contexts do not require Qwen."""
    from cosmos_policy._src.predict2.text_encoders.reason1 import QwenVLBaseModel
    from cosmos_policy._src.reason1.configs.default.model_config_qwen import (
        QwenModelConfig,
        QwenVisionConfig,
    )
...
class TextEncoderConfig:
    ...
    model_config: Any = attrs.field(factory=_default_reason1_model_config)
