...
from cosmos_policy._src.imaginaire.utils.context_parallel import broadcast_split_tensor
...
from cosmos_policy.conditioner import (
    GeneralConditioner,
    Text2WorldCondition,
)
...
class Video2WorldCondition(Text2WorldCondition):
    """Mutable version of Video2WorldCondition for Cosmos Policy."""
    ...
    # Optional per-batch gate in [0,1] for tactile self-attn logit bias (Franka tactile); shape (B,).
...
class VideoPredictionWan2pt1Condition(Text2WorldCondition):
    """Mutable version of VideoPredictionWan2pt1Condition for Cosmos Policy."""
