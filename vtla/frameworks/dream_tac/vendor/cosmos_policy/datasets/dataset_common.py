...
def load_or_compute_dataset_statistics(
    data_dir: str,
    data: dict,
    calculate_dataset_statistics_func,
    ...
    Args:
        ...
        stats_filename (str): Basename of the stats file (default: dataset_statistics.json).
            Use a different name (e.g. dataset_statistics_franka.json) to avoid loading
            stats from a different action dimension (e.g. ALOHA 14-dim vs Franka 7-dim).

    Returns:
        dict: Dataset statistics with numpy array values
    """
    dataset_stats_path = os.path.join(data_dir, stats_filename)
...
def load_or_compute_post_normalization_statistics(
    data_dir: str,
    data: dict,
    calculate_dataset_statistics_func,
    stats_filename: str = "dataset_statistics_post_norm.json",
):
    """
    ...
    Args:
        ...
        calculate_dataset_statistics_func: Function to compute statistics from data
        stats_filename (str): Basename of the post-norm stats file.

    Returns:
        dict: Post-normalization dataset statistics with numpy array values
    """
    dataset_stats_post_norm_path = os.path.join(data_dir, stats_filename)
