...
def _policy_video_vae(
    ...
    load_mean_std=False,
    mean_std_path: str = "/path/to/Cosmos-Predict2-2B-Video2World/tokenizer/tokenizer.pth",
    **kwargs,
):
    """
...
class CosmosPolicyWanVAE:
    ...
    def __init__(
        self,
        z_dim=16,
        vae_pth="/path/to/Cosmos-Predict2-2B-Video2World/tokenizer/tokenizer.pth",
        s3_credential_path: str = "credentials/s3_training.secret",
        load_mean_std=False,
        mean_std_path: str = "/path/to/Cosmos-Predict2-2B-Video2World/tokenizer/mean_std.pt",
...
class Wan2pt1VAEInterface(VideoTokenizerInterface):
    ...
    def __init__(self, chunk_duration: int = 81, load_mean_std=False, **kwargs):
        ...
        self.model = CosmosPolicyWanVAE(
            ...
            vae_pth=kwargs.get(
                "vae_pth",
                "/path/to/Cosmos-Predict2-2B-Video2World/tokenizer/tokenizer.pth",
            ),
